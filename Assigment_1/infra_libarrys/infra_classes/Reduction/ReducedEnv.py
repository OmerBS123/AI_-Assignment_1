from Assigment_1.infra_libarrys.infra_classes.Reduction.ReducedEdge import ReducedEdge
from Assigment_1.infra_libarrys.infra_classes.Reduction.ReducedNode import ReducedNode

class State:
    ...
    def __eq__(self, other):
        # return self.env == other.env and self.curr_node == other.curr_node and self.agent.score == other.agent.score and self.agent.packages == other.agent.packages
        return self.curr_node == other.curr_node and self.agent.score == other.agent.score and self.agent.packages == other.agent.packages
